...
const nav: NavItem[] = [
  ...
  { label: 'Services', to: '/#services', caret: true },
  {
    ...
    menu: [
      ...
      { title: 'Live@razinsoft', desc: 'Explore our life, culture and workplace.', to: '/life', tone: 'bg-emerald-50 text-emerald-600', arrow: 'text-emerald-500', icon: ['M9 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z', 'M17 11a3 3 0 1 0 0-6', 'M3 20a6 6 0 0 1 12 0', 'M16.5 14.5A6 6 0 0 1 21 20'] },
